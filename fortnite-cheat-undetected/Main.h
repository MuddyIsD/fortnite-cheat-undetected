...
struct {
	...
	//enemy item color ==============================================================
	float DrawFOVCircle[4] = { color.LightCyanBlue[0], color.LightCyanBlue[1], color.LightCyanBlue[2] };
	...
	float CrossHair[3] = { color.LightCyanBlue[0], color.LightCyanBlue[1], color.LightCyanBlue[2] };
